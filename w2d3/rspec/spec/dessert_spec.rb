...
describe Dessert do
  ...
  subject(:cake) { Dessert.new("cake", 8, chef) }
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("cake", "boop", :chef) }.to raise_error(ArgumentError)
    end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ...
      cake.mix!
      expect(cake.ingredients).to_not eq(%w(flour sugar eggs chocolate))
    end
  end
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect { cake.eat(9) }.to raise_error
    end
  end
